...
final class ruleAlphaSpaceTest extends \unitTestHelper
{
    protected $config;
    protected $validateParent;
    protected $alphaSpace;
    ...
    protected function setUp(): void
    {
        ...
        $this->alphaSpace = new \peel\validate\rules\alphaSpace($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->alphaSpace->isValid($value,'a,b,c');
