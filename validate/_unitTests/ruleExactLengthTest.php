...
final class ruleExactLengthTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->exactLength = new \peel\validate\rules\exactLength($this->config,$this->validateParent);
    }
    ...
    public function testEmpty(): void
    {
        ...
        $this->exactLength->isValid($value,'');
    ...
    public function testOneof(): void
    {
        ...
        $this->exactLength->isValid($value,'a,b,c');
