...
final class ruleGreaterThanEqualToTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->greaterThanEqualTo = new \peel\validate\rules\greaterThanEqualTo($this->config,$this->validateParent);
    }
    ...
    public function testEmpty(): void
    {
        ...
        $this->greaterThanEqualTo->isValid($value,'');
    ...
    public function testOneof(): void
    {
        ...
        $this->greaterThanEqualTo->isValid($value,'a,b,c');
