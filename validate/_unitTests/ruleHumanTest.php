...
final class ruleHumanTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->human = new \peel\validate\rules\human($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->human->isValid($value,'a,b,c');
