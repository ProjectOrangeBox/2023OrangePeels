...
final class ruleIsArrayTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->isArray = new \peel\validate\rules\isArray($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->isArray->isValid($value,'a,b,c');
