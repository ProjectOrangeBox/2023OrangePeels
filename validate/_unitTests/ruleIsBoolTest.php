...
final class ruleIsBoolTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->isBool = new \peel\validate\rules\isBool($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->isBool->isValid($value,'a,b,c');
