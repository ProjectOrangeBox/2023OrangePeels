...
final class ruleIsClassTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->isClass = new \peel\validate\rules\isClass($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->isClass->isValid($value,'a,b,c');
