...
final class ruleIsLowercaseTest extends \unitTestHelper
{
    protected $config;
    protected $validateParent;
    protected $isLowercase;
    ...
    protected function setUp(): void
    {
        ...
        $this->isLowercase = new \peel\validate\rules\isLowercase($this->config,$this->validateParent);
    }
    ...
    public function testEmpty(): void
    {
        ...
        $this->isLowercase->isValid($value,'');
    ...
    public function testOneof(): void
    {
        ...
        $this->isLowercase->isValid($value,'a,b,c');
