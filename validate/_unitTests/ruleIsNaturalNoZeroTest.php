...
final class ruleIsNaturalNoZeroTest extends \unitTestHelper
{
    protected $config;
    protected $validateParent;
    protected $isNaturalNoZero;
    ...
    protected function setUp(): void
    {
        ...
        $this->isNaturalNoZero = new \peel\validate\rules\isNaturalNoZero($this->config,$this->validateParent);
    }
    ...
    public function testEmpty(): void
    {
        ...
        $this->isNaturalNoZero->isValid($value,'');
    ...
    public function testOneof(): void
    {
        ...
        $this->isNaturalNoZero->isValid($value,'a,b,c');
