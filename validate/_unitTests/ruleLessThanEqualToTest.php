...
final class ruleLessThanEqualToTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->lessThanEqualTo = new \peel\validate\rules\lessThanEqualTo($this->config,$this->validateParent);
    }
    ...
    public function testEmpty(): void
    {
        ...
        $this->lessThanEqualTo->isValid($value,'');
    ...
    public function testOneof(): void
    {
        ...
        $this->lessThanEqualTo->isValid($value,'a,b,c');
