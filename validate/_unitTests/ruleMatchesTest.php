...
final class ruleMatchesTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->Matches = new \peel\validate\rules\Matches($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->Matches->isValid($value,'a,b,c');
