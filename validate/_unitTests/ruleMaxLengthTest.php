...
final class ruleMaxLengthTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->maxLength = new \peel\validate\rules\maxLength($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->maxLength->isValid($value,'a,b,c');
