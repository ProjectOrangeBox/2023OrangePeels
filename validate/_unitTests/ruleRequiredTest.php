...
final class ruleRequiredTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->required = new \peel\validate\rules\required($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->required->isValid($value,'a,b,c');
