...
final class ruleValidDateTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->validDate = new \peel\validate\rules\validDate($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->validDate->isValid($value,'a,b,c');
