...
final class ruleValidIPTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->validIP = new \peel\validate\rules\validIP($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->validIP->isValid($value,'a,b,c');
