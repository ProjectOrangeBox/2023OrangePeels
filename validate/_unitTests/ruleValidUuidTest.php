...
final class ruleValidUuidTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->validUuid = new \peel\validate\rules\validUuid($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->validUuid->isValid($value,'a,b,c');
