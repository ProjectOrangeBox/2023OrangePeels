...
$singleTemplate = file_get_contents(__DIR__ . '/support/filter.single.tmpl.php');
$fileTemplate = file_get_contents(__DIR__ . '/support/filter.body.tmpl.php');

foreach ($filters as $basename => $namespace) {
    $body = '';
    ...
    $className = 'filter' . ucfirst($basename) . 'Test';
