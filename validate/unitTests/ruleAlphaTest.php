...
final class ruleAlphaTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->alpha = new \peel\validate\rules\alpha($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->alpha->isValid($value,'a,b,c');
