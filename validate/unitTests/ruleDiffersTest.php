...
final class ruleDiffersTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->Differs = new \peel\validate\rules\Differs($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->Differs->isValid($value,'a,b,c');
