...
final class ruleIsDecimalTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->isDecimal = new \peel\validate\rules\isDecimal($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->isDecimal->isValid($value,'a,b,c');
