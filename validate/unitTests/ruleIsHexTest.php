...
final class ruleIsHexTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->isHex = new \peel\validate\rules\isHex($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->isHex->isValid($value,'a,b,c');
