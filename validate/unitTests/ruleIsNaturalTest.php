...
final class ruleIsNaturalTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->isNatural = new \peel\validate\rules\isNatural($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->isNatural->isValid($value,'a,b,c');
