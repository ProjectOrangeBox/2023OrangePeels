...
final class ruleOneOfTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->oneOf = new \peel\validate\rules\oneOf($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->oneOf->isValid($value,'a,b,c');
