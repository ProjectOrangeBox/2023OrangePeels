...
final class ruleValidEmailTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->validEmail = new \peel\validate\rules\validEmail($this->config,$this->validateParent);
    }
    ...
    public function testOneof(): void
    {
        ...
        $this->validEmail->isValid($value,'a,b,c');
