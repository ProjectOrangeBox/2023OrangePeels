...
final class ruleValidJsonTest extends \unitTestHelper
{
    protected $config;
    ...
    protected function setUp(): void
    {
        ...
        $this->validJson = new \peel\validate\rules\validJson($this->config,$this->validateParent);
    }
    ...
    {
        $value = '{"name":"Johnny Appleseed","age": 27}';
    ...
    {
        $value = '[{"name":"Johnny"},"dog","cat","fish"]';
    ...
    public function testOneof(): void
    {
        ...
        $this->validJson->isValid($value,'a,b,c');
